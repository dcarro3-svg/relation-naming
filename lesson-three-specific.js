...
function submitNaming(r){
  ...
  else if(unknownRole==='smaller') isCorrect=r.indexOf(larger)<r.indexOf(diff)&&r.includes('minus');
  else isCorrect=r.indexOf(larger)<r.indexOf(smaller)&&r.includes('minus');
