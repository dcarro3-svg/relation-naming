...
const INSTRUCT=[
  ...
  },
  {
    ...
    opts(m){return[`The ${m.p2.color.name} part remains.`,`The ${m.whole.color.name} part remains.`,`Nothing remains — it all equals the missing part.`];},
    ...
    fuOpts:['We use the word minus or subtract.','We use the word plus or add.','We use the word times or multiply.'],
  ...
  },
  {
    ...
    opts:['Addition finds the whole.','Subtraction finds the whole.','Multiplication finds the whole.'],
    ...
    fuOpts:['Subtraction finds a missing part.','Addition finds a missing part.','Division finds a missing part.'],
